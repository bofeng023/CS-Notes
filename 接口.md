...
###### URL
> [http://192.168.0.106:8080/LaborBlance/findOnceCards]
...
###### URL
> [http://192.168.0.106:8080/LaborBlance/getBalance]
...
|orderPrice |string |订单金额                         |
|deduction |string |抵扣金额                         |
|redeemCode |string |兑换码集合 code:兑换码 price:价格 name:名称 类型:1次卡2优惠券 状态:true有效false失效    |
|benefit |string |人工优惠金额                         |
...
###### URL
> [http://192.168.0.106:8080/LaborBlance/finance]
...
|wechatPayMoney |string |微信支付金额                 |
|aliPayMoney |string |支付宝支付金额                         |
...
###### URL
> [http://192.168.0.106:8080/payCallback/workorder]
